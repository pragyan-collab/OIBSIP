...
plt.suptitle('')
plt.tight_layout()
plt.savefig('/mnt/user-data/outputs/03_Feature_Comparison_BoxPlots.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('/mnt/user-data/outputs/05_Confusion_Matrix.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('/mnt/user-data/outputs/06_Feature_Importance.png', dpi=300, bbox_inches='tight')
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig('/mnt/user-data/outputs/07_ROC_Curves.png', dpi=300, bbox_inches='tight')
